# Module 5: Modular Programming with Functions: Code Examples
...
```python
# Demo code snippet
print("Running demo for Module 5: Modular Programming with Functions")
```

**Expected Output:**
```
Running demo for Module 5: Modular Programming with Functions
```
