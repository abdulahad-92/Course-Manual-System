# Module 4: Container Data Types (Lists, Tuples, Sets, Dictionaries): Code Examples
...
```python
# Demo code snippet
print("Running demo for Module 4: Container Data Types (Lists, Tuples, Sets, Dictionaries)")
```

**Expected Output:**
```
Running demo for Module 4: Container Data Types (Lists, Tuples, Sets, Dictionaries)
```
